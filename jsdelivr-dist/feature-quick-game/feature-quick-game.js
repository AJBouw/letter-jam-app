const H = globalThis, R = H.ShadowRoot && (H.ShadyCSS === void 0 || H.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, L = Symbol(), B = /* @__PURE__ */ new WeakMap();
let Z = class {
  constructor(t, e, s) {
...
const it = (r) => new Z(typeof r == "string" ? r : r + "", void 0, L), rt = (r, ...t) => {
...
const { is: ot, defineProperty: ht, getOwnPropertyDescriptor: at, getOwnPropertyNames: lt, getOwnPropertySymbols: ct, getPrototypeOf: dt } = Object, T = globalThis, q = T.trustedTypes, pt = q ? q.emptyScript : "", ut = T.reactiveElementPolyfillSupport, S = (r, t) => r, N = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? pt : null;
      break;
  ...
  return e;
} }, Y = (r, t) => !ot(r, t), V = { attribute: !0, type: String, converter: N, reflect: !1, useDefault: !1, hasChanged: Y };
...
g.elementStyles = [], g.shadowRootOptions = { mode: "open" }, g[S("elementProperties")] = /* @__PURE__ */ new Map(), g[S("finalized")] = /* @__PURE__ */ new Map(), ut?.({ ReactiveElement: g }), (T.reactiveElementVersions ??= []).push("2.1.1");
const j = globalThis, O = j.trustedTypes, W = O ? O.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, X = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, tt = "?" + _, $t = `<${tt}>`, A = document, C = () => A.createComment(""), w = (r) => r === null || typeof r != "object" && typeof r != "function", z = Array.isArray, _t = (r) => z(r) || typeof r?.[Symbol.iterator] == "function", k = `[ 	
\f\r]`, E = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, F = /-->/g, G = />/g, f = RegExp(`>|${k}(?:([^\\s"'>=/]+)(${k}*=${k}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), J = /'/g, K = /"/g, et = /^(?:script|style|textarea|title)$/i, ft = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), mt = ft(1), y = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), Q = /* @__PURE__ */ new WeakMap(), m = A.createTreeWalker(A, 129);
function st(r, t) {
...
const At = (r, t) => {
  ...
  for (let l = 0; l < e; l++) {
    const h = r[l];
    let c, p, a = -1, u = 0;
    for (; u < h.length && (o.lastIndex = u, p = o.exec(h), p !== null); ) u = o.lastIndex, o === E ? p[1] === "!--" ? o = F : p[1] !== void 0 ? o = G : p[2] !== void 0 ? (et.test(p[2]) && (i = RegExp("</" + p[2], "g")), o = f) : p[3] !== void 0 && (o = f) : o === f ? p[0] === ">" ? (o = i ?? E, a = -1) : p[1] === void 0 ? a = -2 : (a = o.lastIndex - p[2].length, c = p[1], o = p[3] === void 0 ? f : p[3] === '"' ? K : J) : o === K || o === J ? o = f : o === F || o === G ? o = E : (o = f, i = void 0);
    const $ = o === f && r[l + 1].startsWith("/>") ? " " : "";
    n += o === E ? h + $t : a >= 0 ? (s.push(c), h.slice(0, a) + X + h.slice(a) + _ + $) : h + _ + (a === -2 ? l : $);
  }
    ...
    for (; (i = m.nextNode()) !== null && h.length < l; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const a of i.getAttributeNames()) if (a.endsWith(X)) {
          ...
          h.push({ type: 1, index: n, name: U[2], strings: $, ctor: U[1] === "." ? yt : U[1] === "?" ? vt : U[1] === "@" ? Et : M }), i.removeAttribute(a);
...
bt?.(P, x), (j.litHtmlVersions ??= []).push("3.3.1");
const Ct = (r, t, e) => {
...
const wt = D.litElementPolyfillSupport;
wt?.({ LitElement: b });
...
class Pt extends b {
  ...
  constructor() {
    super(), this.message = "Try the quick game!";
  }
  handleClick() {
...
customElements.get("feature-quick-game") || customElements.define("feature-quick-game", Pt);
function Ht(r, t = {}) {
  if (!r) return;
  const e = document.createElement("feature-quick-game");
