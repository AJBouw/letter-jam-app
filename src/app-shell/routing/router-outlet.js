...
import { connectivityService, sharedGameSession, wsService } from '@letter-limbo/common';
...
export class RouterOutlet extends ScopedElementsMixin(LitElement) {
  ...
  _renderRoute() {
    ...
    if (gameMatch) {
      return html`
        <feature-game-root-view
          ...
          .sharedGameSession=${sharedGameSession}
          .wsService=${wsService}
    ...
    // Quick Start
    if (path === '/games/quick-start') return html`
      <feature-quick-game-view
        .sharedGameSession=${sharedGameSession}
        .wsService=${wsService}
        .connectivityService=${connectivityService}
      ></feature-quick-game-view>
